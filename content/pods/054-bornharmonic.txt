...
Everett's Many Worlds interpretation@ref(everett, "Everett, H. Relative state formulation of quantum mechanics (1957). Many Worlds. Douady, A. and Hubbard, J. On the dynamics of polynomial-like maps (1985). Harmonic measure on Julia sets.") makes this more acute: if all branches are real, why do we experience some branches more than others? The probability has to come from somewhere.
