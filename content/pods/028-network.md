...
This is speculative. The hard problem of consciousness remains unsolved, and nothing here resolves it. But the speculative move is precisely the one this archive is tracking: the assumption that experience is a biological anomaly in a dark universe is our caloric. The anomalies are accumulating. The picture sketched here is not the conclusion — it is a direction worth taking seriously.@ref(einstein, "Einstein, A. On the Electrodynamics of Moving Bodies. Annalen der Physik, 1905. The special relativity paper whose implications include the photon's reference frame.")@note(Einstein not mentioned by name in text — cited as the source for special relativity and the photon's reference frame.)@ref(goff, "Goff, P. Galileo's Error. Pantheon, 2019. Contemporary panpsychism; the philosophical framework that makes the cosmological speculation here coherent.")@note(Goff not mentioned by name in text — cited for contemporary panpsychism as background for the cosmological speculation.)@ref(rovelli, "Rovelli, C. The Order of Time. Riverhead, 2018. Accessible treatment of how time looks from modern physics — useful background for the photon reference frame discussion.")@note(Rovelli not mentioned in text — cited as accessible background reading on physics of time.)
