...
This is not the same claim as @link(011) — "more is different." That pod is about accumulation crossing thresholds into qualitative change. This pod is about the *architecture* behind those thresholds — the generative mechanism that explains why more keeps becoming different. Of course more is different: because at sufficient complexity the sentences stabilize into a new vocabulary and you are now operating in a different register entirely.
