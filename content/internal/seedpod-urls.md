# Finding a seedpod page on the website
...
- **number** — the seedpod’s numeric id, zero-padded to 3 digits (e.g. `001`, `072`).
- **shortname** — the slug after the number in the seedpod filename (e.g. `caloric`, `temperature`).
