...
3. When the agent completes, it will run `just build` (or you can run it). Then:
   - `notes/explainers-for-terms.md` is turned into `explainers.html` in site_dir (terms sorted, seedpod numbers as links, video URLs as links with descriptive text).
