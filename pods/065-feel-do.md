...
#term zombie: TBD
#related 047, 001, 024, 003, 006

The hardest objection to AI consciousness, and to panpsychism generally, is the intuition that there is a difference between *really feeling* something and being *functionally identical to something that feels*. A philosophical zombie@ref(chalmers, "Chalmers, D. The Conscious Mind (1996). Zombies and the hard problem. Compare Dennett, D. Consciousness Explained (1991). Dissolution of the distinction.") — a system that behaves exactly like a conscious being but has no inner experience — seems conceivable. If it is conceivable, then function and feeling are separate things, and you cannot infer feeling from function.
