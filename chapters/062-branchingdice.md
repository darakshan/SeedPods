...
Assigning uniform @term(probability, "a measure of how possibility is distributed over alternatives; here, what falls out of giving each branch of an n-fold node an equal 1/n share.") 1/n to each branch of an n-branching node gives a natural probability measure on the boundary, the @term(harmonic measure, harmonic measure)@ref(douady, "Douady, Adrien and Hubbard, John H.", "*Étude dynamique des polynômes complexes*. Publications Mathématiques d'Orsay 84-02 and 85-04, 1984–85.", "External rays and the potential theory that defines harmonic measure on the boundary of the Mandelbrot set.")@note(The uniform 1/n weighting described here is not, in general, the harmonic measure: harmonic measure is the push-forward of Lebesgue measure on the circle under the Riemann map of the exterior, and it does not reduce to equal weight per branch at an n-fold node. The qualitative claim, that simpler branches carry more weight, survives; the identification of the two measures does not, and needs either a proof or a weaker phrasing.).
