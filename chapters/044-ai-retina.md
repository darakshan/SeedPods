...
This convergence is predicted by the @term(efficient coding hypothesis, efficient coding hypothesis, "sensory systems are structured to optimally compress the statistics of natural inputs; predicts convergence of evolution and learning.")@ref(barlow, "Barlow, Horace", "*Redundancy Reduction Revisited*. Network: Computation in Neural Systems, 2001.", "Efficient coding and the structure of natural signals."): the visual system is structured the way it is because it is a near-optimal compression scheme for natural image statistics, and those statistics are dominated by the color temperature of sunlight, the edges of objects, and the opponent contrasts of vegetation and sky.
